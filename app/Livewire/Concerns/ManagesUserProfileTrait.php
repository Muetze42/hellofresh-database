...
trait ManagesUserProfileTrait
{
    ...
    /**
     * Initialize profile properties from the authenticated user.
     */
    protected function mountUserProfile(): void
    {
        $user = auth()->user();
    ...
    /**
     * Hook called after email has been changed.
     * Override this method to add redirect or other behavior.
     */
    protected function afterEmailChanged(): void
    {
        // Default: no action. Override in component if needed.
    }
}
