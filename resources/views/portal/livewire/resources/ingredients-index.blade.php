<flux:main container class="space-y-section">
  ...
  <flux:breadcrumbs>
    ...
    <flux:breadcrumbs.item>Ingredients</flux:breadcrumbs.item>
  </flux:breadcrumbs>

  <flux:heading size="xl">Ingredients</flux:heading>
        ...
        @empty
          <flux:table.row>
            <flux:table.cell colspan="7" class="text-center py-section">
              <flux:text variant="subtle">No ingredients found.</flux:text>
            </flux:table.cell>
          </flux:table.row>
        @endforelse
      </flux:table.rows>
