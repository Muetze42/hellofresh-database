    ...
    <Dialog as="div" class="fixed z-50 inset-0 px-4">
      ...
      >
        ...
        >
          <DialogPanel
            as="div"
            class="border border-gray-800/50 bg-gray-900 rounded-sm inline-block align-bottom overflow-hidden shadow-xl transform transition-all sm:align-middle w-full text-left"
            :class="size"
          >
